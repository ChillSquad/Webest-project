          ...
          <div class="policy-page__chapter-content">
            ...
            <div class="policy-page__chapter-list">
              ...
              <p>
                ...
                интернет-статистики (Яндекс Метрика). Категории данных,
                обрабатываемых с помощью сервисов Яндекс Метрика: URL страницы,
                Реферер страницы, Заголовок страницы, Браузер и его версия,
                Операционная система и ее версия, Устройство, Высота и ширина
                экрана, Наличие Cookies, Наличие JavaScript, Часовой пояс, Язык
                браузера, Глубина цвета экрана, Ширина и высота клиентской части
                окна браузера, Пол и возраст посетителей, Интересы посетителей,
                Географические данные, Учет взаимодействий посетителя с сайтом,
                в том числе использование на сайте методов JavaScript API
                (JavaScript-события), Параметры загрузки страницы, Просмотр
                страницы, Визит, Переход по внешней ссылке, Скачивание файла,
          ...
          <div class="policy-page__chapter-content">
            <div class="policy-page__chapter-list">
              ...
              <p>
                ...
                товаров, работ, услуг на рынке; связь с Пользователем и его
                информирование посредством отправки электронных писем, смс
                сообщений и звонков, в том числе направление ему уведомлений,
                запросов и информации, касающихся использования им сайта
            ...
            <div class="policy-page__chapter-list">
              ...
              <p>
                ...
                электронной почты dir@webest.ru с пометкой «Отказ от
            ...
            <div class="policy-page__chapter-list">
              ...
              <p>
                ...
                персональных данных, Оператором обрабатываются все,
                перечисленные в п. 3.1. Политики и поступившие от Пользователя
                персональные данные. Все персональные данные обрабатываются с
          ...
          <div class="policy-page__chapter-content">
            <div class="policy-page__chapter-list">
              ...
              <p>
                ...
                https://webest.ru . Заполняя соответствующие формы и/или
                отправляя свои персональные данные Оператору, Пользователь
                выражает свое согласие с данной Политикой и Согласием на
          ...
          <div class="policy-page__chapter-content">
            ...
            <div class="policy-page__chapter-list">
              ...
              <p>
                ...
                лет с момента дачи согласия на их обработку. Пользователь может
                в любой момент отозвать свое согласие на обработку персональных
                данных путем направления письменного уведомления в произвольной
                форме в ООО «Вэбест» по адресу: Россия, 162626, Вологодская
                обл., г.Череповец, ул. Годовикова, д.21, помещение 4 Н. Оператор
