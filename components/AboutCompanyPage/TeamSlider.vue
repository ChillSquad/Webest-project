...
const reviews = [
  {
    ...
    content2: [
      "График работы. Он довольно строгий. Раньше был более гибкий. Возможно, не всем это подходит, идет усреднение. В этом есть положительные стороны и отрицательные. Т.к. есть отрицательные, значит можно улучшить.",
